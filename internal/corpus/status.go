...
func Status(db *sql.DB, root string) (map[string]any, error) {
	...
	for _, table := range []string{"machines", "bundles", "sources", "files", "sessions", "session_versions", "entries", "messages", "artifacts", "images", "entry_assets", "session_path_tokens", "artifact_path_tokens", "conflicts", "fts_messages", "fts_artifacts"} {
		var n int
