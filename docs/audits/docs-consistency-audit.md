...
*Historical: predates depot v2 ([../depot-v2-spec.md](../depot-v2-spec.md)). The bundle/catalogue vocabulary and depot mechanics this audit normalized were replaced by content-addressed snapshots (blobs + manifests + pointers) in June 2026.*
...
- Current CLI nouns are consistent: **bundle**, **depot**, **catalogue**, **corpus**, **ref**.
...
- `README.md` now matches no-op refresh behaviour by documenting unchanged depot-bundle reuse via `state_sha256` metadata.
...
- `docs/refactor-metrics-and-go-audit.md` captures the duplication-refactor before/after metrics, profiling artefacts, regression verification, and Go best-practices audit.
